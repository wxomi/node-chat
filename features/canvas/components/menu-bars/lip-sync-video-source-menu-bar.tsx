...
const LipSyncVideoSourceMenuBar: React.FC<MenuBarProps> = ({
  options,
  activeOptionId,
  nodeId,
  onOptionClick,
...
LipSyncVideoSourceMenuBar.displayName = "LipSyncVideoSourceMenuBar";

export default LipSyncVideoSourceMenuBar;
