...
import { handleUpscaleImagePrototype } from "../../../handlers/image";
...
import { SCALE_FACTOR_OPTIONS } from "../../../constants/nodes/image/ai-image-upscaler-config";
import {
  Tooltip,
  TooltipContent,
  TooltipTrigger,
...
type AIImageUpscalerNodePrototypeProps = {
  id: string;
  selected?: boolean;
  dragging?: boolean;
};

const AIImageUpscalerNodePrototype: React.FC<AIImageUpscalerNodePrototypeProps> =
  memo(({ id, selected, dragging }) => {
    ...
    // Calculate additional height for scale factor selector
    ...
    const handleGenerate = useCallback(async () => {
      await handleUpscaleImagePrototype(id);
    }, [id]);
      ...
      <>
        ...
        <NodeAnimation>
          ...
          >
            ...
            {/* Embedded scale factor selector */}
            <CustomSelect
...
AIImageUpscalerNodePrototype.displayName = "AIImageUpscalerNodePrototype";

export default AIImageUpscalerNodePrototype;
