...
type AIImageEditorNodeProps = {
  id: string;
  selected?: boolean;
  dragging?: boolean;
};

const AIImageEditorNode: React.FC<AIImageEditorNodeProps> = memo(
      ...
      <>
        ...
        <OutputGhostNodeSuggestions
          ...
          onHoverChange={(isOutputGhostHovered) => {
            // Sync with node's hover states for output ghost nodes
...
export default AIImageEditorNode;
