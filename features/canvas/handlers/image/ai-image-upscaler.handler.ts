...
export async function handleUpscaleImage(nodeId: string) {
      ...
      try {
        await poll({
          ...
          onError: (data: any) => {
            ...
            console.error("[handleUpscaleImage] Polling completed with error", {
          ...
          onCanceled: () => {
            ...
            console.warn("[handleUpscaleImage] Polling canceled", {
              imageId: apiResult.id,
            });
